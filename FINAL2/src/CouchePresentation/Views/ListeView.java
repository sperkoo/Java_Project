...
public class ListeView extends JFrame {
    ...
    public ListeView() {
        ...
        JButton newListeButton = new JButton("+ Nouvelle liste");
        ...
        supprimer.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (listId != null) {
                    int confirmation = JOptionPane.showConfirmDialog(ListeView.this, "Êtes-vous sûr de vouloir supprimer cette liste ?", "Confirmation", JOptionPane.YES_NO_OPTION);
                    if (confirmation == JOptionPane.YES_OPTION) {
                        deleteList(listId);
                    }
                } else {
                    JOptionPane.showMessageDialog(ListeView.this, "Veuillez sélectionner une liste à supprimer.", "Avertissement", JOptionPane.WARNING_MESSAGE);
                }
            }
        });

        searchButton.addActionListener(e -> SearchListe());
        setVisible(true);
    }
    ...
    public void openModifierListe() {
        ...
        ModifierListeController controller = new ModifierListeController(modifierListeView, listeModel,
                getSelectedListeIdFromTable());
    ...
    private void SearchListe() {
        String keyword = searchField.getText().trim().toLowerCase();
        List<Liste> filteredData = gestionListe.searchListesByKeyword(keyword);
