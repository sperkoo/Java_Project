...
public class UpdateProjectView extends JFrame{
    ...
    public UpdateProjectView() {
        ...
        addToLayout(contentPane, typeLabel, 0, 1, constraints);
        addToLayout(contentPane, typeComboBox, 1, 1, constraints);
    ...
    public static void main(String[] args) {
        new UpdateProjectView().setVisible(true);
    }
}
