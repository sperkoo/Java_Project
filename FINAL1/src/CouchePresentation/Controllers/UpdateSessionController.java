...
import CouchePresentation.Views.UpdateSessionView;
...
public class UpdateSessionController {
    private UpdateSessionView sessionView;
    private SessionModel sessionModel;
    private String IdSeance;
    private String IdProjet;

    public UpdateSessionController(UpdateSessionView view, SessionModel model, String idSeance, String idProjet) {
